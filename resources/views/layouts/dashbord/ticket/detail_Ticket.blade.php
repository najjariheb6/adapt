                            ...
                            <tr class="table__row">
                                ...
                                <td class="table__td text-center text-dark-theme">
                                    <div class="d-inline-block">
                                        <div class="input-group input-group--prepend-xs">
                                            <div class="input-group__prepend">$</div>
                                            <div class="input input--edit prod_price" contenteditable="true"></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="table__td text-center">
                                    <input class="input input--edit text-center text-light-theme" type="number" value="1" min="1" max="999">
                                </td>
                                <td class="table__td text-nowrap text-dark-theme">$</td>
